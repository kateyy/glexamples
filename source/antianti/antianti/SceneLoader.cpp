...
namespace
{
    ...
    std::vector<glm::vec3> lightPositions = {{0, 20, 0},     {0, 54, 0},        {0, 18, 0},        {0, 2000, 0},      {10, 20, 0},      {0, 18, 0},        {-2, 6, -2},       };
    std::vector<float> lightMaxShifts =   {0.1f,             1.0f,              1.0f,              15.0f,             0.7f,             1.0f,              0.2f,              };
}
