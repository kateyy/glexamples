...
namespace
{
    ...
    std::vector<glm::vec3> camPositions = {{0.2, 1.5, -2.8}, {-4.5, 32.0, 8.7}, {15.5, 3.9, 0.1},  {-1300, 250, -23}, {0.25, 4.1, 4.75},{-0.025,0.25,-2.9},{0.34, 0.39, -0.48},};
    std::vector<glm::vec3> camViews =     {{0.0, -1.5, 2.6}, {0.9, -1.9, -2.1}, {-3.0, -0.9, 0.0}, {3.0, -0.5, 0.0},  {0.0, -1.8, -2.4},{-0.014,-0.25,0.75},{-0.24, -0.37, 0.33},};
    std::vector<bool> enableGrid =        {true,             true,              false,             false,             false,            false,             false,             };
    std::vector<glm::vec2> ssaoSettings = {{0.05, 1.0},      {0.8, 1.5},        {0.5, 1.5},        {15.0, 1.5},       {0.5, 1.0},       {0.125, 1.5},      {0.1, 1.5},        };
